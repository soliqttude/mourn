...
mournbot is a hybrid Discord bot — every command works as both a **slash command** and a **prefix command** (default prefix: `,`). Built on discord.js v14, TypeScript, and PostgreSQL via Drizzle ORM.
